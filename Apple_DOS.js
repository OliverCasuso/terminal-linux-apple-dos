...
// Función para imprimir el texto línea por línea
function imprimirLineaPorLinea(texto, index) {
  if (index === texto.length) {
    return;
  }
  
  process.stdout.write(texto[index]);

  setTimeout(() => {
    imprimirLineaPorLinea(texto, index + 1);
  }, 15); // Retraso entre cada carácter de 15 milisegundos
}

imprimirLineaPorLinea(texto, 0);
